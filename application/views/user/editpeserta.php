        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
			...
			<form action="<?= base_url('user/editpeserta') ?>"method="post">
      <div class="modal-body">
           ...
           <div class="form-group">
             ...
             <input type="text" class="form-control" id="sekolah" name="sekolah" placeholder="Sekolah" value="<?= $data['sekolah'];  ?>">
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
                ...
                <input type="date" class="form-control" id="tanggal_akhir" name="tanggal_akhir" value="<?= $data['tanggal_akhir'];  ?>">
                <br/>
           </div>
