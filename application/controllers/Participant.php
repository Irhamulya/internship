...
private function _sendEmail($id)
	{
		...
		$this->email->message('<!DOCTYPE html>
			...
			<div class="topnav" style="overflow: hidden;
			  ...
			  font-family: arial;
			  padding: 8px 14px;"><b>Bandung Design Info</b></h2>
			  <p style="text-align: left;
			  font-family: arial;
			  padding: 8px 14px;">Congratulations !!! from now you are part of the intern in Bandung Design !!! </p>
			  ...
			  color: white;
			  text-align: center;">BandungDesign.com</p>
			</div>
	...
	private function _sendEmail2($id)
	{
		...
		$this->email->message('<!DOCTYPE html>
			...
			<div class="topnav" style="overflow: hidden;
			  ...
			  <p style="text-align: left;
			  font-family: arial;
			  padding: 8px 14px;">Sorry you not you are not the choosen one for intern in Bandung Design !!! </p>
			  <p style="
			  left: 0;
			  bottom: 1;
			  width: 100%;
